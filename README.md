...
The **Copy tasks** action lets you copy all weekly tasks from one weekday to another.
...
Copied tasks keep their task name, start time, end time, and weekly-repeat setting. Exact duplicates already present on the destination weekday are skipped.
...
- Mobile-first UI
- PWA support
- Copy weekly tasks from one weekday to another
